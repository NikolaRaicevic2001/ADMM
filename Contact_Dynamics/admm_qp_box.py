...
#  ★  USER CONFIG  ★
# ══════════════════════════════════════════════════════════════════════════════
MANIPULATED_OBJECT = "box"                          # "circle"  or  "box"
TARGET_CIRCLE      = np.array([360.0, 130.0])          # (x, y)
...
v_box       = np.zeros(3)
q_circ      = np.array([WIDTH/2 + 130.0, HEIGHT/2 - 200.0])
v_circ      = np.zeros(2)
...
_video_path = results_dir / "admm_recording_qp_box.mp4"
